/*
 * Opgemaakte bevestigingsmails voor de klant — high-end, in de huisstijl
 * van Agroria (donkergroen, goud, serif-typografie). Er zijn drie varianten:
 *
    ...
    <tr><td align="center">
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%">
        ...
        <tr><td style="background:#1C3320;padding:0 48px 0;font-size:0;line-height:0">
          <img src="${esc(o.fotoUrl)}" alt="${esc(o.fotoAlt || '')}" width="504" style="width:100%;max-width:504px;height:auto;display:block;border:1px solid #33402B">
        </td></tr>
        ...
        <tr><td style="background:#14180F;padding:26px 48px;text-align:center">
          ...
          <div style="margin-top:8px"><a href="${esc(o.siteUrl)}" style="font-family:Arial,Helvetica,sans-serif;color:#C0A063;font-size:12px;text-decoration:none">${esc(String(o.siteUrl).replace(/^https?:\/\//, ''))}</a></div>
        </td></tr>
        <tr><td style="height:3px;background:#C0A063;font-size:0;line-height:0">&nbsp;</td></tr>
