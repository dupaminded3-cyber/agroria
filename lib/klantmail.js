  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#EFEDE6;padding:36px 14px">
    <tr><td align="center">
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%">
        ...
        <!-- Voet -->
        <tr><td style="background:#14180F;padding:30px 48px;text-align:center">
          ${logoUrl ? `
          <img src="${esc(logoUrl)}" alt="Agroria" width="120" style="width:120px;max-width:50%;height:auto;display:block;margin:0 auto">
          ` : `
          ...
          `}
          ${contactFooter ? `<div style="font-family:Arial,Helvetica,sans-serif;color:#8A9080;font-size:12px;margin-top:14px;line-height:1.7">${contactFooter}</div>` : ''}
          ${zakelijkFooter ? `<div style="font-family:Arial,Helvetica,sans-serif;color:#6C7363;font-size:11px;margin-top:6px;line-height:1.7">${zakelijkFooter}</div>` : ''}
