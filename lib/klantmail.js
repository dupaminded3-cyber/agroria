    ...
    <tr><td align="center">
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%">
        ...
        <tr><td style="background:#14180F;padding:30px 48px;text-align:center">
          ...
          ${contactFooter ? `<div style="font-family:Arial,Helvetica,sans-serif;color:#8A9080;font-size:12px;margin-top:12px;line-height:1.7">${contactFooter}</div>` : ''}
          <div style="margin-top:6px"><a href="${esc(siteUrl)}" style="font-family:Arial,Helvetica,sans-serif;color:#C0A063;font-size:12px;text-decoration:none">${esc(String(siteUrl).replace(/^https?:\/\//, ''))}</a></div>
        </td></tr>
        <tr><td style="height:3px;background:#C0A063;font-size:0;line-height:0">&nbsp;</td></tr>
