...
let configuredDir = '';   // wat er in DATA_DIR is ingesteld
let storageError = '';    // eventuele foutmelding waarom de schijf niet werkt
...
module.exports = { read, write, id, ensure, DATA_DIR, DB_FILE, persistent, configuredDir, storageError };
