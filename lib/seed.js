...
const standaardPaginas = {
  ...
  aanbod: { foto1: '', foto2: '' },
  contact: {
    adres: 'Vechtensteinlaan 12, 3555XS Utrecht',
...
// Eenmalige correctie: het adres stond eerst zonder postcode in de database.
// Alleen de exacte oude waarde wordt vervangen — een zelf aangepast adres
// blijft altijd ongemoeid.
if (data.pages.contact && data.pages.contact.adres === 'Vechtensteinlaan 12, Utrecht') {
  data.pages.contact.adres = 'Vechtensteinlaan 12, 3555XS Utrecht';
}
